// Target definition
#define RG_TARGET_NAME             "FREENOVE-ESP32-S3"
...
#define RG_GAMEPAD_ADC_MAP {\
    {RG_KEY_DOWN,    ADC_UNIT_1, ADC_CHANNEL_1, ADC_ATTEN_DB_11, 3072, 4096},\
    {RG_KEY_RIGHT, ADC_UNIT_1, ADC_CHANNEL_2, ADC_ATTEN_DB_11, 0, 1024},\
    {RG_KEY_UP,  ADC_UNIT_1, ADC_CHANNEL_1, ADC_ATTEN_DB_11, 0, 1024},\
    {RG_KEY_LEFT,  ADC_UNIT_1, ADC_CHANNEL_2, ADC_ATTEN_DB_11, 3072, 4096},\
}


#define RG_GAMEPAD_VIRT_MAP {\
    {RG_KEY_OPTION, .src = RG_KEY_START | RG_KEY_SELECT    },\
}

#define RG_GAMEPAD_I2C_MAP { \
    {RG_KEY_MENU,     .num = 4,.pullup=1, .level = 0},\
    {RG_KEY_SELECT,     .num = 0,.pullup=1, .level = 0},\
    {RG_KEY_START,     .num = 3,.pullup=1, .level = 0},\
    {RG_KEY_A,     .num = 1,.pullup=1, .level = 0},\
    {RG_KEY_B,     .num = 2,.pullup=1, .level = 0},\
}
...
#define RG_BATTERY_ADC_CHANNEL      ADC_CHANNEL_8
